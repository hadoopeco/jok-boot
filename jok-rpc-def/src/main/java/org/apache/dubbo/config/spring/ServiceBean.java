...
//    private ApplicationEventPublisher applicationEventPublisher;
    ...
    public ServiceBean(CloudService service) {
        this.appendAnnotation(CloudService.class, service);
    }
    ...
    protected Class getServiceClass(T ref) {
        return AopUtils.isAopProxy(ref) ? AopUtils.getTargetClass(ref) : super.getServiceClass(ref);
    }
